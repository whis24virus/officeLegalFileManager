...
13. Baldur's Gate 3
    ...
    prompt = f"""Task: Filter the list in the context based on the user's question.
Context:
{text}

Question: {query}
Important: You MUST only output items that strictly match the criteria in the question. Do not include any other items.
...
Answer:"""
    ...
    if llm_service._is_available():
        ...
        print("Filtered Prompt Answer:", answer)
